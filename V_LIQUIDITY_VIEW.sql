CREATE OR REPLACE VIEW V_LIQUIDITY_VIEW AS
...
(
SELECT NFA.* from V_NET_FOREIGN_ASSET NFA
UNION ALL
SELECT AFA.* FROM V_AUTONOMOUS_FACTOR AFA
UNION ALL
SELECT NOM.* FROM V_NET_OPEN_MARKET NOM
UNION ALL
SELECT TRE.* FROM V_TOTAL_RESERVED TRE
UNION ALL
SELECT FRA.* FROM V_FOREIGN_ASSET FRA
