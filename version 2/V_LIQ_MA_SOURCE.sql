CREATE OR REPLACE VIEW V_LIQ_MA_SOURCE AS
...
FROM UPLD_BALANCE_SHEET BS LEFT JOIN UPLD_REPORT UR ON BS.BS_REPORT_ID = UR.UPLD_RPT_REPORT_ID
LEFT JOIN REF_GL_MAINTAIN_MAPPING GLMNT ON BS.BS_GL_NUMBER = GLMNT.MTN_FLEXCUBE_GL_ACCOUNT
WHERE UR.UPLD_RPT_STATUS_ID = '2' 
